...
public class FixedDaySupplier extends DeliveringSupplier {
    ...
    public FixedDaySupplier(WindowType currentDeliveryDay,String name, String business_id, String payment_method, String suplier_ID, Contact_Person person, Contract contract, Map<Item, Float> items) {
