...
public class NonFixedDaySupplier extends DeliveringSupplier{
    ...
    public NonFixedDaySupplier(int numOfDayToDeliver,String name, String business_id, String payment_method, String suplier_ID, Contact_Person person, Contract contract, Map<Item,Pair<Integer, Float>> items) {
