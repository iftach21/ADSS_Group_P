...
class driverControllerTests {
    ...
    {
        //Set minimum item temp with TempLevel.regular and find driver with corresponding license
        Driver ChosenDriver = driverControllerTest.findDriver(TempLevel.regular);

        //test if equals
        assertEquals(this.driver1, ChosenDriver);
    }

    @Test
    void findDriverTest2()
    {
        //Set CurrMinTemp with TempLevel.frozen and find driver with corresponding license
        Driver ChosenDriver = driverControllerTest.findDriver(TempLevel.frozen);

        //test if equals
        assertEquals(this.driver3, ChosenDriver);
    }
}
